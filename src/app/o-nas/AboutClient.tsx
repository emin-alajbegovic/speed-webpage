...
const milestones = [
  ...
  { year: '2016', text: 'Modernizacija flote z novimi vozili' },
  { year: '2019', text: 'Odprtje logističnega centra v Mariboru' },
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center mb-20">
            ...
            >
              ...
              <p className="text-[var(--muted-foreground)] leading-relaxed">
                Danes smo ponosni, da pokrivamo celotno Evropo s floto 15+ vozil in ekipo strokovnjakov, ki so na voljo 24 ur na dan, 7 dni v tednu. Naša predanost kakovosti in inovativnosti nas uvršča med vodilne transportne partnerje v regiji.
              </p>
            </motion.div>
